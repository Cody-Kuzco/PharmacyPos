        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl shadow-xl border border-white/20 overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/3 p-4 sm:p-6 lg:p-8">
              <div className="grid gap-3 sm:gap-4 lg:gap-4 lg:grid-cols-2 items-start">
                {/* User Type */}
                ...
                {/* Bio */}
                <div className="flex items-start p-3 sm:p-4 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg sm:rounded-xl border border-indigo-100 lg:col-span-2">
                ...
                {/* Edit Profile Button */}
                <div className="pt-2 sm:pt-3 lg:pt-4 lg:col-span-2">
                  <Link href={`/dashboard/editProfile/${session?.user?._id}`}>
